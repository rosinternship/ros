...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef CONSTANT
#endif
#if defined(_WIN32) && defined(CONSTANT_TWO)
  #undef CONSTANT_TWO
#endif
...
bool operator==(const ::test_rosbag::Constants_<ContainerAllocator1> & lhs, const ::test_rosbag::Constants_<ContainerAllocator2> & rhs)
{
