...
struct Unmigrated_
{
  ...
  _field1_type field1;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _field2_type;
  _field2_type field2;
...
struct Printer< ::test_rosbag::Unmigrated_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test_rosbag::Unmigrated_<ContainerAllocator>& v)
  {
    ...
    s << indent << "field2: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.field2);
    s << indent << "field3: ";
