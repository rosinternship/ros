...
struct MigratedImplicit_
{
  ...
  _field4_type field4;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _field3_type;
  _field3_type field3;
...
struct Printer< ::test_rosbag::MigratedImplicit_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test_rosbag::MigratedImplicit_<ContainerAllocator>& v)
  {
    ...
    s << indent << "field3: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.field3);
    s << indent << "field2: ";
