...
bool operator==(const ::test_roslib_comm::TypeNameChangeArray2_<ContainerAllocator1> & lhs, const ::test_roslib_comm::TypeNameChangeArray2_<ContainerAllocator2> & rhs)
{
  return lhs.a == rhs.a;
}
