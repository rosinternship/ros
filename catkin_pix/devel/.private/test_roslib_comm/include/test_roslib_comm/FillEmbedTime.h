...
struct FillEmbedTime_
{
  ...
  _str_msg_type str_msg;
   ...
   typedef std::vector< ::std_msgs::String_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::std_msgs::String_<ContainerAllocator> >> _str_msg_array_type;
...
bool operator==(const ::test_roslib_comm::FillEmbedTime_<ContainerAllocator1> & lhs, const ::test_roslib_comm::FillEmbedTime_<ContainerAllocator2> & rhs)
{
  return lhs.t == rhs.t &&
    lhs.d == rhs.d &&
    lhs.str_msg == rhs.str_msg &&
    lhs.str_msg_array == rhs.str_msg_array &&
    lhs.i32 == rhs.i32;
}
