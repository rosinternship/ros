...
struct ArrayOfMsgs_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::std_msgs::String_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::std_msgs::String_<ContainerAllocator> >> _strings_type;
  _strings_type strings;

   typedef std::vector< ::std_msgs::Time_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::std_msgs::Time_<ContainerAllocator> >> _times_type;
  _times_type times;

   typedef std::vector< ::std_msgs::MultiArrayLayout_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::std_msgs::MultiArrayLayout_<ContainerAllocator> >> _muls_type;
  _muls_type muls;
...
bool operator==(const ::test_roslib_comm::ArrayOfMsgs_<ContainerAllocator1> & lhs, const ::test_roslib_comm::ArrayOfMsgs_<ContainerAllocator2> & rhs)
{
