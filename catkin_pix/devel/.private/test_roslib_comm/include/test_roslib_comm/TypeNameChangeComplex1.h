...
struct TypeNameChangeComplex1_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::test_roslib_comm::SameSubMsg1_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::test_roslib_comm::SameSubMsg1_<ContainerAllocator> >> _a_type;
  _a_type a;
...
bool operator==(const ::test_roslib_comm::TypeNameChangeComplex1_<ContainerAllocator1> & lhs, const ::test_roslib_comm::TypeNameChangeComplex1_<ContainerAllocator2> & rhs)
{
  return lhs.a == rhs.a &&
    lhs.b == rhs.b;
}
