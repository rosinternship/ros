...
struct SameSubMsg1_
{
  ...
  _d_type d;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _e_type;
  _e_type e;
...
bool operator==(const ::test_roslib_comm::SameSubMsg1_<ContainerAllocator1> & lhs, const ::test_roslib_comm::SameSubMsg1_<ContainerAllocator2> & rhs)
{
  return lhs.a == rhs.a &&
    lhs.b == rhs.b &&
    lhs.c == rhs.c &&
