...
bool operator==(const ::test_roscpp::BadTestStringStringRequest_<ContainerAllocator1> & lhs, const ::test_roscpp::BadTestStringStringRequest_<ContainerAllocator2> & rhs)
{
  return lhs.strbad == rhs.strbad;
}
