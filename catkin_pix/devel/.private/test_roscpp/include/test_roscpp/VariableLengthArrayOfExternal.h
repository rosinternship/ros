...
bool operator==(const ::test_roscpp::VariableLengthArrayOfExternal_<ContainerAllocator1> & lhs, const ::test_roscpp::VariableLengthArrayOfExternal_<ContainerAllocator2> & rhs)
{
  return lhs.a == rhs.a;
}
