...
bool operator==(const ::test_roscpp::VariableLengthStringArray_<ContainerAllocator1> & lhs, const ::test_roscpp::VariableLengthStringArray_<ContainerAllocator2> & rhs)
{
