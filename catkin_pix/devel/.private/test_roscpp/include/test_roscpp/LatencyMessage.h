...
bool operator==(const ::test_roscpp::LatencyMessage_<ContainerAllocator1> & lhs, const ::test_roscpp::LatencyMessage_<ContainerAllocator2> & rhs)
{
  return lhs.publish_time == rhs.publish_time &&
    lhs.receipt_time == rhs.receipt_time &&
    lhs.count == rhs.count &&
    lhs.thread_index == rhs.thread_index &&
    lhs.array == rhs.array;
}
