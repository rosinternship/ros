...
bool operator==(const ::test_rospy::ListReturnRequest_<ContainerAllocator1> & lhs, const ::test_rospy::ListReturnRequest_<ContainerAllocator2> & rhs)
{
  return lhs.a == rhs.a &&
    lhs.b == rhs.b &&
    lhs.c == rhs.c &&
...
struct Definition< ::test_rospy::ListReturnRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# test case for having single list return value\n"
"int32 a\n"
"int32 b\n"
"int32 c\n"
"int32 d\n"
