...
struct EmbedTest_
{
  ...
  _int1_type int1;
   ...
   typedef std::vector< ::std_msgs::Int32_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::std_msgs::Int32_<ContainerAllocator> >> _ints_type;
  _ints_type ints;
  ...
  _vals_type vals;
   ...
   typedef std::vector< ::test_rospy::ArrayVal_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::test_rospy::ArrayVal_<ContainerAllocator> >> _arrayval_type;
...
bool operator==(const ::test_rospy::EmbedTest_<ContainerAllocator1> & lhs, const ::test_rospy::EmbedTest_<ContainerAllocator2> & rhs)
{
