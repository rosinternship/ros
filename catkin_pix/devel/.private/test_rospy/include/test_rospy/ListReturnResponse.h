...
struct ListReturnResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _abcd_type;
  _abcd_type abcd;
...
bool operator==(const ::test_rospy::ListReturnResponse_<ContainerAllocator1> & lhs, const ::test_rospy::ListReturnResponse_<ContainerAllocator2> & rhs)
{
  return lhs.abcd == rhs.abcd;
}
