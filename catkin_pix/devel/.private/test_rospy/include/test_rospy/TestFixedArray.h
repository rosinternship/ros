...
struct TestFixedArray_
{
  ...
  TestFixedArray_(const ContainerAllocator& _alloc)
    ...
    , b_3()  {
      ...
      s_1.assign(std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>(_alloc));

      s_3.assign(std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>(_alloc));
  ...
  _u32_3_type u32_3;
   ...
   typedef boost::array<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 1>  _s_1_type;
  _s_1_type s_1;

   typedef boost::array<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, 3>  _s_3_type;
  _s_3_type s_3;
...
bool operator==(const ::test_rospy::TestFixedArray_<ContainerAllocator1> & lhs, const ::test_rospy::TestFixedArray_<ContainerAllocator2> & rhs)
{
  return lhs.f32_1 == rhs.f32_1 &&
    lhs.f32_3 == rhs.f32_3 &&
    lhs.f64_1 == rhs.f64_1 &&
    lhs.f64_3 == rhs.f64_3 &&
    lhs.i8_1 == rhs.i8_1 &&
...
struct Printer< ::test_rospy::TestFixedArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test_rospy::TestFixedArray_<ContainerAllocator>& v)
  {
    ...
    {
      s << indent << "  s_1[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.s_1[i]);
    }
    s << indent << "s_3[]" << std::endl;
    for (size_t i = 0; i < v.s_3.size(); ++i)
    {
      s << indent << "  s_3[" << i << "]: ";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.s_3[i]);
    }
