...
struct ArrayVal_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::test_rostopic::Val_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::test_rostopic::Val_<ContainerAllocator> >> _vals_type;
  _vals_type vals;
...
bool operator==(const ::test_rostopic::ArrayVal_<ContainerAllocator1> & lhs, const ::test_rostopic::ArrayVal_<ContainerAllocator2> & rhs)
{
