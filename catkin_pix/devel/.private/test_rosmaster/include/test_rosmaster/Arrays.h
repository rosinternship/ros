...
struct Arrays_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<int8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int8_t>> _int8_arr_type;
  _int8_arr_type int8_arr;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _uint8_arr_type;
  _uint8_arr_type uint8_arr;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _int32_arr_type;
  _int32_arr_type int32_arr;

   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _uint32_arr_type;
  _uint32_arr_type uint32_arr;

   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _string_arr_type;
  _string_arr_type string_arr;

   typedef std::vector<ros::Time, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<ros::Time>> _time_arr_type;
...
bool operator==(const ::test_rosmaster::Arrays_<ContainerAllocator1> & lhs, const ::test_rosmaster::Arrays_<ContainerAllocator2> & rhs)
{
  return lhs.int8_arr == rhs.int8_arr &&
    lhs.uint8_arr == rhs.uint8_arr &&
    lhs.int32_arr == rhs.int32_arr &&
    lhs.uint32_arr == rhs.uint32_arr &&
    lhs.string_arr == rhs.string_arr &&
    lhs.time_arr == rhs.time_arr;
}
...
struct Printer< ::test_rosmaster::Arrays_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test_rosmaster::Arrays_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.string_arr.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.string_arr[i]);
    }
