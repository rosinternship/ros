...
bool operator==(const ::test_rosmaster::RossrvARequest_<ContainerAllocator1> & lhs, const ::test_rosmaster::RossrvARequest_<ContainerAllocator2> & rhs)
{
  return lhs.areq == rhs.areq;
}
